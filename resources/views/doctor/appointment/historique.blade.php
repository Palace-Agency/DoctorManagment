            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>
                            List of appointment
                            <a href="{{ route('appointment.index') }}" class="btn btn-primary float-end">Back</a>
                                ...
                                <tbody>
                                    @foreach ($appointments as $appointment)
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="{{$appointment->status == "completed" ? 'badge text-bg-success' : 'badge text-bg-danger'}}"><strong class="text-light text-capitalize">{{$appointment->status}}</strong></span></td>
                                            <td>
                                                <div class="btn-group">
                ...
                <form action="{{route('appointment.update')}}" method="post">
                    ...
                    <div class="row mt-2">
                        ...
                        <select name="" id="" class="form-control">
                            <option value="">the status can't change</option>
                        </select>
                    </div>
                </div>
                <div class="modal-footer border-0">
