                        ...
                        <form method="POST" action="{{route('expense.update',$expense->id)}}" class="form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="name" value="{{$expense->name}}" class="form-control @error('name') is-invalid @enderror">
                                        @error('name')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$expense->amount}}" class="form-control @error('amount') is-invalid @enderror" name="amount" required="">
                                        @error('amount')
                                        <span class="text-danger" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" {{$expense->status === 'paid' ? 'checked':''}} name="status" type="radio" value="paid">
                                    <label class="form-check-label">
                                    Paid
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" name="status"  type="radio" value="unpaid" {{$expense->status === 'unpaid' ? 'checked':''}}>
                                    <label class="form-check-label" >
                                    Unpaid
                                    </label>
                                </div>
