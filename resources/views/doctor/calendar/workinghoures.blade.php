                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active p-4" id="nav-home" role="tabpanel"
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-2">
                                        <div class="form-control border-0 mb-0">
                                            <input class="form-check-input" value="1" name="off[]"
                                                {{ isset($workingdays['sunday'][0]['day_off']) && $workingdays['sunday'][0]['day_off'] == 'disable' ? 'checked' : '' }}
                                                type="checkbox" id="checkbox-primary-7">
                                            <input type="hidden" name="nameofday[]" class="day" value="sunday">
                                            <label class="form-check-label" for="checkbox-primary-7">sunday</label>
                                        </div>
                                    </div>
                                    <div class="col-md-3 work-hours" style="{{ isset($workingdays['sunday'][0]['start_time']) ? '' : 'display: none;' }}">
                                        <div class="m-1 ftime work-hours" style="{{ isset($workingdays['sunday'][0]['start_time']) ? '' : 'display: none;' }}">
                                            <input class="form-control digits" type="time"
                                                value="{{ $workingdays['sunday'][0]['start_time'] ?? '' }}"
                                                name="start_time[]">
                                        </div>
                                    </div>
                                    <div class="col-md-3 ml-1 work-hours" style="{{ isset($workingdays['sunday'][0]['end_time']) ? '' : 'display: none;' }}">
                                        <div class="m-1 stime">
                                            <input class="form-control digits" type="time"
                                                value="{{ $workingdays['sunday'][0]['end_time'] ?? '' }}"
                                                name="end_time[]">
                                        </div>
                                    </div>
                                    <div class="col-md-2 work-hours" style="{{ isset($workingdays['sunday'][0]['end_time']) ? '' : 'display: none;' }}">
                                        <div class="m-1 type">
                                            <select class="form-select" name="type_consult[]" id="validationTooltip04">
                                                @foreach (['personnel', 'remote', 'both'] as $item)
                                                    <option
                                                        {{ isset($workingdays['sunday'][0]['type_consultation']) && $workingdays['sunday'][0]['type_consultation'] == $item ? 'selected' : ($item == 'Personnel' ? 'selected' : '') }}
                                    ...
                                    <div class="col-md-2 mt-2 work-hours" style="{{ isset($workingdays['sunday'][0]['start_time']) ? '' : 'display: none;' }}">
                                        @if (isset($workingdays['sunday'][1]))
                                ...
                                <div class="row add work-hours"
                                    style="{{ isset($workingdays['sunday'][1]) ? '' : 'display: none;' }}">
                                    <div class="col-md-2">
                                    </div>
                                    <div class="col-md-3">
                                        <div class="m-1 ftime ">
                                            <input class="form-control digits2" type="time"
                                                value="{{ isset($workingdays['sunday'][1]['start_time']) ? $workingdays['sunday'][1]['start_time'] : '' }}"
                                                name="start_time2[]">
                                        </div>
                                    </div>
                                    <div class="col-md-3 ml-1">
                                        <div class="m-1 stime ">
                                            <input class="form-control digits2" type="time"
                                                value="{{ isset($workingdays['sunday'][1]['end_time']) ? $workingdays['sunday'][1]['end_time'] : '' }}"
                                                name="end_time2[]">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="m-1 type">
                                            ...
                                            @php
                                                $defaultValue = isset($workingdays['sunday'][1]['type_consultation']) ? $workingdays['sunday'][1]['type_consultation'] : 'personnel';
                                            @endphp
                                            @foreach (['personnel', 'remote', 'both'] as $item)
