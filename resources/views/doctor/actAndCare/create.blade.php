        ...
        @endif
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('actcare.storeAct')}}" class="form">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-contol">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" name="nameact" value="{{old('nameact')}}" class="form-control @error('nameact') is-invalid @enderror">
                                            @error('nameact')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="name_m" value="{{old('name_m')}}" class="form-control @error('name_m') is-invalid @enderror">
                                        @error('name_m')
                                            <span class="text-danger" role="alert">
                                                <strong>{{$message}}</strong>
                                            </span>
                                    ...
                                    <div class="form-contol">
                                        ...
                                        <select class="form-control select2 select2-accessible" aria-label="Default select example" name='category_act' required>
                                            ...
                                            @foreach ($category_acts as $category_act)
                                                <option value="{{$category_act->id}}">{{$category_act->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('honoraires') is-invalid @enderror" value="{{old('honoraires')}}" name="honoraires">
                                        @error('honoraires')
                                        <span class="text-danger" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('coefficient') is-invalid @enderror" value="{{old('coefficient')}}" name="coefficient">
                                        @error('coefficient')
                                        <span class="text-danger" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
