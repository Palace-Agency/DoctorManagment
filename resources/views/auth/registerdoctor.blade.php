...
<div class="row m-0">
    <div class="col-12 p-0">
        ...
        <div>
            <div><a class="logo" href="{{route('homepage')}}"><img class="img-fluid for-light w-25" src="{{asset("images/logo/landing_logo.png")}}" alt="looginpage"><img class="img-fluid for-dark" src="{{asset("assets/images/logo/logo_dark.png")}}" alt="looginpage"></a></div>
