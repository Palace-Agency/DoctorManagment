        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form class="row g-3 needs-validation custom-input" method="POST" action="{{route('motif.store')}}">
                        @csrf
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input class="form-control @error('namemotif') is-invalid  @enderror"  type="text" name="namemotif" >
                            @error('namemotif')
