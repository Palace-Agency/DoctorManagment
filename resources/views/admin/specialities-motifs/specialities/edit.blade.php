        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form class="row g-3 needs-validation custom-input" method="POST" action="{{route('speciality.update',$speciality->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="col-md-12 position-relative">
                            <label class="form-label">Name speciality <span class="text-danger">*</span></label>
                            <input value="{{$speciality->name_sp}}" class="form-control @error('namespeciality') is-invalid  @enderror"  type="text" name="namespeciality" >
                        ...
                        <div class="col-md-12 position-relative">
                            ...
                            <textarea class="form-control @error('description') is-invalid  @enderror" name="description" id="" cols="" rows="5">{{$speciality->description}}</textarea>
                            @error('description')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
