@section('title','create persmissions')
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form class="row g-3 needs-validation custom-input" method="POST" action="{{route('permission.store')}}">
                        @csrf

                        <div class="col-md-12 position-relative">
                            <label class="form-label">Name Permission <span class="text-danger">*</span></label>
                            <input class="form-control @error('namepermission') is-invalid  @enderror"  type="text" name="namepermission" >
